...
<fieldset>
    ...
    <form action="edit_tb1.php?id='11'" method="POST" enctype="multipart/form-data">
        <table>
            <tr>
                <td>Tên trang bị: </td>
            ...
            <tr>
                <td>Giá:  </td>
                <td><input type="text" size="10px" name="txtgia" value=""></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td> Tên Nội Tại 1: </td>
                <td><input type="text" name="txtnoita1" value=""></td>
            </tr>
            ...
            <tr>
                <td>Tên Nội Tại 2: </td>
                <td><input type="text" name="txtnoita2" value=""></td>
            </tr>
