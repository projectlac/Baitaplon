        ...
        <div class="container"><a class="navbar-brand" href="TrangChu.php">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="btn-group"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="mvc-vukhi.php">Trang Bị</a>
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item"  href="mvc-vukhiC.php">Sát Thương</a><a class="dropdown-item" role="presentation" href="mvc-vukhiP.php">Phòng Thủ</a><a class="dropdown-item" role="presentation" href="mvc-vukhiD.php">Đa Dụng</a></div>
                    </li>
